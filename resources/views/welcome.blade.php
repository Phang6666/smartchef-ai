    ...
    <main class="flex-grow">
        <div class="max-w-3xl mx-auto px-6">
            ...
            @if (isset($recipe) && is_array($recipe))
                <div id="recipe-card" class="max-w-3xl mx-auto mt-12 p-6 md:p-10 bg-white rounded-3xl shadow-2xl relative overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_-5px_rgba(16,185,129,0.3)]">
